namespace AlarmSystem
{
    partial class AboutBox1
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.labelProductName.Text = "产品名称：排土场灾害预警管控系统";
            ...
            this.labelVersion.Text = "版本：V1.0（2017）";
            ...
            this.labelCopyright.Text = "版权：中国劳动关系学院，北京石油化工学院";
            ...
            this.labelCompanyName.Text = "用户名称：贵州省劳动保护科学技术研究院";
            ...
            this.textBoxDescription.Text = "说明：本软件基于排土场灾害预警的两种算法，即单指标预警和多指标综合预警算法，实现排土场灾害的实时在线预警。预警结果不仅能够在线显示和保存功能，而且能够以短信方式发" +
    "送给企业管理员。预警信息将在排土场灾害监测中心同步显示，便于高层查看和跟踪。";
            // 
            // okButton
            // 
